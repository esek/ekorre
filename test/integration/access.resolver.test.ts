  ...
  const [setIndividualAccessRes, setPostAccessRes] = await Promise.all([
    requestWithAuth(
      SET_USER_ACCESS_MUTATION,
      {
        ...
        access: {
          doorEndDates: [{ door:Door.Bd, endDate:null}],
          featureEndDates:[{ feature:Feature.AccessAdmin, endDate:null}],
        },
      },
      superadminToken,
    ),
    requestWithAuth(
      SET_POST_ACCESS_MUTATION,
      {
        postId: mockPost.id,
        access: {
          doorEndDates: [{ door:Door.Hk, endDate:null}],
          featureEndDates:[{ feature:Feature.Superadmin, endDate:null}],
        },
      },
      superadminToken,
    ),
