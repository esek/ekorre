...
export type Query = {
  ...
  individualDoorAccess: Array<User>;
 ...
 * does not take an `electionId` parameter.
 */
export type QueryIndividualDoorAccessArgs = {
  door: Door;
};
 ...
 * does not take an `electionId` parameter.
 */
export type QueryPostDoorAccessArgs = {
  door: Door;
};
...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  individualDoorAccess?: Resolver<Array<ResolversTypes['User']>, ParentType, ContextType, RequireFields<QueryIndividualDoorAccessArgs, 'door'>>;
  ...
  postDoorAccess?: Resolver<Array<ResolversTypes['User']>, ParentType, ContextType, RequireFields<QueryPostDoorAccessArgs, 'door'>>;
