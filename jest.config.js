...
const serialTests = ['test/regression/election.test.ts', 'test/unit/election.api.test.ts', 'test/integration/article.test.ts', 'ekorre/test/integration/article.test.ts']
