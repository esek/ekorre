...
### Tillagt
 - `Dockerfile.ci` för CI skript. Detta går även att använda lokalt
 om man vill paketera sin nuvarande build
### Ändrat
 - Uppdaterat CI skript för att vara mer smidiga
 - Flyttat `sqlite3` från devDependencies till vanlig
